        ...
        <form class="bg-dark mt-4 mb-4 px-5 py-4 rounded" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
            ...
            <div class="form-row">
                <div class="form-group col-md-6 my-4">
                    ...
                    <input type="date" class="form-control col-11" id="birthdate" name="birthdate" />
                ...
                <div class="form-group col-md-6 my-4">
                    ...
                    <input type="text" class="form-control col-11" id="phone_number" name="phone_number" minlength="10" maxlength="10" placeholder="Inserisci numero di telefono" required />
            ...
            <div class="form-row">
                <div class="form-group col-md-6 my-4">
                    ...
                    <input type="email" class="form-control col-11" id="email" name="email" placeholder="Inserisci email" required />
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6 my-4">
                    ...
                    <input type="password" class="form-control col-11" id="repeat_passowrd" name="repeat_password" placeholder="Inserisci password" required />
                    <label for=""  class="col-11 text-left mt-2 error-label"><?php if(isset($_POST['password-error']))echo$_POST['password-error'];?></label>
                </div>
            </div>
        ...
        <form class="bg-dark mt-4 mb-4 px-5 py-4 rounded" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6 my-4">
                    ...
                    <input type="text" class="form-control col-11" id="p_iva" name="p_iva" minlength="11" maxlength="11" placeholder="00000000000" required />
