<?php $seller = $templateParams["seller"][0];?>
        ...
        <form class="bg-dark mt-4 mb-4 px-5 py-4 rounded">
            ...
            <div class="form-row">
                <div class="form-group col-md-6 my-4">
                    ...
                    <input type="text" class="form-control col-11" disabled id="name" aria-describedby="" placeholder="<?php echo $seller["name"]; ?>">
                </div>
                <div class="form-group col-md-6 my-4">
                    <label for="email" class="col-11 text-left mt-2">Email:</label>
                    <input type="email" class="form-control col-11" id="email" aria-describedby="emailHelp" placeholder="<?php echo $seller["email"]; ?>">
                </div>        
            </div>
            <div class="form-row">
                <div class="form-group col-md-6 my-4">
                    <label for="phone-number" class="col-11 text-left mt-2">Telefono:</label>
                    <input type="tel" class="form-control col-11" id="phone-number" aria-describedby="" placeholder="<?php echo $seller["phone"]; ?>">
                </div>    
                <div class="form-group col-md-6 my-4">
                    <label for="iva" class="col-11 text-left mt-2">Partita IVA:</label>
                    <input type="text" class="form-control col-11" id="iva" aria-describedby="" placeholder="<?php echo $seller["p_iva"]; ?>">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6 my-4">
