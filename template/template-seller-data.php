        ...
        <form class="bg-dark mt-4 mb-4 px-5 py-4 rounded" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>">
            ...
            <div class="form-row">
                <div class="form-group col-md-6 my-4">
                    ...
                    <input type="text" name="name" class="form-control col-11" id="name" value="<?php echo $sellerData["name"]; ?>">
                </div>
                <div class="form-group col-md-6 my-4">
                    <label for="email" class="col-11 text-left mt-2">Email:</label>
                    <input type="email" class="form-control col-11" name="email" id="email" readonly value="<?php echo $sellerData["email"]; ?>">
                </div>        
            </div>
            <div class="form-row">
                <div class="form-group col-md-6 my-4">
                    <label for="phone_number" class="col-11 text-left mt-2">Telefono:</label>
                    <input type="tel" class="form-control col-11" name="phone_number" id="phone_number" value="<?php echo $sellerData["phone"]; ?>">
                </div>    
                <div class="form-group col-md-6 my-4">
                    <label for="p_iva" class="col-11 text-left mt-2">Partita IVA:</label>
                    <input type="text" name="p_iva" class="form-control col-11"  id="p_iva" readonly value="<?php echo $sellerData["p_iva"]; ?>">
